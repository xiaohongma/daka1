...
#if 1 
    if (!ReadTrackPairs("/storage/sdcard/matcher/track-pairs.txt")) {
        start = clock();
        ...
        WriteTrackPairs("/storage/sdcard/matcher/track-pairs.txt");
        end = clock();
...
#if 0
    FILE *f = fopen("/storage/sdcard/matcher/overhead.txt", "w");
