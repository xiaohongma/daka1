                    ...
                    std::vector<point_t> &points)
{
    ...
    printf("[ReadBundleFile] Reading %d images and %d points...\n",
	   num_images, num_points);
    LOGI("[ReadBundleFile] Reading %d images and %d points...\n",
           num_images, num_points);
                     ...
                     const std::vector<point_t> &points)
{
    ...
    LOGI("[WriteBundleFile] Writing %d images and %d points...\n",
          num_good_images, num_points);
...
int radial_undistort(int argc, char **argv)
{
    ...
    //LOGI("UndistortImages %s file",files);
